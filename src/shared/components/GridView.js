...
const GridView = ({ buildings }) => {
    ...
    const handleItemPress = (building) => {
        ...
        // navigation.navigate('BuildingDetail', { building })
    };
        ...
        <TouchableWithoutFeedback onPress={() => handleItemPress(item)}>
            <View style={styles.item}>
                ...
                <View style={{ width: 180, paddingTop: 8 }}>
                    ...
                    <Text style={{ color: '#ababab', marginBottom: 8 }}>
                        {item.location}
                    </Text>
    ...
    const renderEmptyComponent = () => (
        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text
                style={{ fontWeight: 'bold', fontSize: 24, color: '#999999' }}
            >No Buildings Available</Text>
        </View>
    );
